    ...
    <div className="app-container fade-in">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-4 items-center justify-between">
        <div className="flex gap-2 w-full md:w-auto">
          <select 
            className="w-full md:w-auto bg-black border border-white/20 rounded-md px-4 py-2 text-sm text-white focus:outline-none focus:border-primary"
            value={filterView}
